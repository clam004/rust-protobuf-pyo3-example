# fork from https://raw.githubusercontent.com/PyO3/pyo3/master/examples/word-count/setup.py
import os
import sys
import subprocess
...
# compile proto
for p in Path(".").glob('./proto/**/*.proto'):
    command = ['protoc', '-I./proto/', '--python_out=./proto_example/generated/', str(p)]
...
setup(
    ...
    packages=["proto_example"],
    rust_extensions=[RustExtension("proto_example.core", "Cargo.toml", debug=True)],
